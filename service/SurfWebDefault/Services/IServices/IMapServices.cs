...
namespace Services.IServices
{
    public interface IMapServices : IBaseServices<MapModel>
    {
        ...
        /// 获取地图前100数量
        /// </summary>
        Task<int> GetMapTop100Count(string id, RecordTypeEnum recordType, int? stage);
        /// <summary>
        /// 获取地图前100
        /// </summary>
        Task<List<MapTop100Dto>> GetMapTop100List(string id, RecordTypeEnum recordType, int? stage, int pageIndex);
        /// <summary>
        /// 获取地图缓存列表
        /// </summary>
