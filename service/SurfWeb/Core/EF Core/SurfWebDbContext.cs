                ...
                optionsBuilder.UseSeeding((context, _) =>
                {
                    ...
                    var fakerRankingModel = new Faker<RankingModel>()
                        ...
                        .RuleFor(m => m.Type, f =>
                        {
                            if (rankingId <= 10)
                            {
                                return RankingTypeEnum.Integral;
                            }
                            else if (rankingId <= 20)
                            {
                                return RankingTypeEnum.MainWR;
                            }
                            else if (rankingId <= 30)
                            {
                                return RankingTypeEnum.BountyWR;
                            }
                            else
                            {
                    ...
                    var fakerNewRecordModel = new Faker<NewRecordModel>()
                        ...
                        .RuleFor(m => m.Type, f =>
                        {
                            if (newRecordId <= 10)
                            {
                                return RecordTypeEnum.Main;
                            }
                            else if (newRecordId <= 20)
                            {
                                return RecordTypeEnum.Bounty;
                            }
                            else
                            {
                        ...
                        {
                            if (m.Type == RecordTypeEnum.Main)
                            {
                                return f.PickRandom(mapDifficulty);
                            }
                            else
                            {
                    ...
                    var fakerMap1PlayerCompleteModel = new Faker<PlayerCompleteModel>()
                        .RuleFor(m => m.Id, f => "map1" + map1PlayerCompleteModelId++.ToString())
                        .RuleFor(m => m.PlayerId, f => f.Random.Int(0, 99).ToString())
                        .RuleFor(m => m.PlayerName, (f, m) => fakerPlayerModel.Where(t => t.Id == m.PlayerId).First().Name)
                        ...
                        .RuleFor(m => m.Type, f =>
                        {
                            if (map1PlayerCompleteModelId <= 100)
                            {
                                return RecordTypeEnum.Main;
                            }
                            else if (map1PlayerCompleteModelId <= 200)
                            {
                                return RecordTypeEnum.Bounty;
                            }
                            else
