...
namespace Services
{
    public class PlayerServices : BaseServices<PlayerModel>, IPlayerServices
    {
        ...
        public PlayerServices(IBaseRepository<PlayerModel> playerRepository,
        ...
        private ISugarQueryable<IGrouping<string?, PlayerCompleteModel>> GetPlayerSucceesQueryable(string id, RecordTypeEnum recordType, string difficulty)
        {
